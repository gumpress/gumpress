...
function set_prompt_command
{
	...
	local show_path="${full_path/$home_path/\~}"
	PS1='\n\[\e[36m\]$MSYSTEM \[\e[33m\]'"$show_path"'\[\e[0m\]\n# '
}

PROMPT_COMMAND=set_prompt_command

alias view='view_alias'
alias code='code_alias'
alias wp='wp.sh'

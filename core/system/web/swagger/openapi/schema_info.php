...
class SchemaInfo
{
	...
	private ?SchemaContact $contact = null;
	private ?SchemaLicense $license = null;
	private ?string $termsOfService = null;

	public function __construct( string $title, string $version, string $description, SchemaContact $contact ) {
		$this->title       = $title;

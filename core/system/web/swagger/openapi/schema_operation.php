...
class SchemaOperation 
{
	...
	public function addResponse( SchemaResponse $response ) {
	...
	public function addParameter( SchemaParameter $parameter ) {
	...
	public function toArray(): array {
		...
		if ( count( $this->parameters ) ) {
			$data['parameters'] = array_map(
				function( SchemaParameter $parameter ) {
	...
	public function getParameterByName( $name ): ?SchemaParameter {
	...
	public function generateParametersFromRouteArgs( $method, array $args, array $pathVariables ): void {
		...
		foreach ( $args as $name => $values ) {
			...
			$parameter = new SchemaParameter( $in, $name, $values['type'], $values['description'], $values['required'] );
		...
		foreach ( $pathVariables as $pathVariable ) {
			if ( ! $this->getParameterByName( $pathVariable ) ) {
				$this->parameters[] = new SchemaParameter( 'path', $pathVariable, 'string', '', true );
			}
		}
	}
}

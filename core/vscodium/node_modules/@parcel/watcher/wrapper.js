const path = { ...require('path'), resolve: (...args) => { let res = require('path').resolve(...args); return res.replace(/\\/g, '/'); } };
const picomatch = require('picomatch');
const isGlob = require('is-glob');

function normalizeOptions(dir, opts = {}) {
  const { ignore, ...rest } = { ...opts, ignore: Array.isArray(opts.ignore) ? opts.ignore.map(v => path.resolve(dir, v)) : opts.ignore };

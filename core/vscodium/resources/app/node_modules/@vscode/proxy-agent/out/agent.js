...
exports.createPacProxyAgent = exports.getProxyURLFromResolverResult = exports.PacProxyAgent = void 0;
...
class PacProxyAgent extends agent_base_1.Agent {
    constructor(resolver, opts = {}, addCAs = () => __awaiter(this, void 0, void 0, function* () { })) {
        super(opts);
        this.casAdded = false;
...
function getProxyURLFromResolverResult(result) {
...
exports.getProxyURLFromResolverResult = getProxyURLFromResolverResult;
...
function createPacProxyAgent(resolver, opts, addCAs) {
    if (!opts) {
        opts = {};
    }
...
exports.createPacProxyAgent = createPacProxyAgent;//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/693a30eb9d23ce457bb08dc02055c3d9ed4c1774/node_modules-@vscode-proxy-agent-out-agent.js.map
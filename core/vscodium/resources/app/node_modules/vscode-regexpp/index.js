...
class RegExpVisitor {
    ...
    visitBackreference(node, parents) {
    ...
    visitCapturingGroup(node, parents) {
    ...
    visitCharacterClass(node, parents) {
    ...
    visitCharacterClassRange(node, parents) {
    ...
    visitCharacterSet(node, parents) {
    ...
    visitRegExpLiteral(node, parents) {
...
exports.visitRegExpAST = visitRegExpAST;//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/693a30eb9d23ce457bb08dc02055c3d9ed4c1774/node_modules-vscode-regexpp-index.js.map
